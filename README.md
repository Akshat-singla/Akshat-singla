# Hi , I'm Akshat Singla  
### 🧠 AI/ML Developer | ⚡ Building SnapLM | 🎨 Visual Systems Enthusiast  
...
◦ Currently learning  
Applied **AI/ML** through real-world systems — LLM workflows, graph reasoning, and intelligent interfaces  

◦ Achievements  
**Winner of 4 Hackathons** — rapid prototyping & solving real-world problems  

◦ Open to collaborate on  
AI/ML, LLMs, knowledge systems, and experimental user interfaces  

◦ Ask me about  
AI systems, DSA, system design, or building end-to-end products  
...
### 🔗 SnapLM  
> Think. Structure. Evolve.  
- Graph-based thinking system  
- LLM-powered interactions  
- Visual + modular knowledge representation  
